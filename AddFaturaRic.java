...
public class AddFaturaRic {
    ...
    try {
	  ...
	  System.out.println(" ********* Início AddFaturaRic *********** ");
...
//Testa se o Folder da Fatura existe....
	  ...
	  aFolder = (Folder)objectStore.getObject(BaseObject.TYPE_FOLDER,"/Emissão RIC/" + folderApoliceName + "/" + folderFaturaName);
      if (aFolder.getClassId() == null){  //não existe
...
// properties.add(property);	  	  
      ...
      //Document document = (Document) objectStore.createObject(ClassDescription.DOCUMENT, properties, null);
        ...
        Folder folder = (Folder) objectStore.getObject (BaseObject.TYPE_FOLDER, "/Emissão RIC/" + folderApoliceName + "/" + folderFaturaName);
